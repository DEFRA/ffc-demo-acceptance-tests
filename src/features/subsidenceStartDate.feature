...
Given I open the url "https://expired.badssl.com/"
Then I expect that the url is "https://expired.badssl.com/"
Then I expect that the title contains "expired.badssl.com"

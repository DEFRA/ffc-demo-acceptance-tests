Feature: Create and submit a new claim
    ...
    Scenario: Successfully complete form to submit a new claim
        ...
        Given I open the url "https://ffc-demo.ffc-dev.aws-int.defra.cloud/"
        ...
        Then I expect that the url is "https://ffc-demo.ffc-dev.aws-int.defra.cloud/claim/property-type"
        When I click on the button "#propertyType"
        When I click on the button ".govuk-button"

        Then I expect that the url is "https://ffc-demo.ffc-dev.aws-int.defra.cloud/claim/accessible"
        ...
        When I click on the button ".govuk-button"
        Then I expect that the url is "https://ffc-demo.ffc-dev.aws-int.defra.cloud/claim/confirmation"